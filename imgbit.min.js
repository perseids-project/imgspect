...
e.param.x2=b[d].coords[2]+e.param.x1;e.param.y2=b[d].coords[3]+e.param.y1;e.param.z=b[d].coords[4];var g=b[d].wipe,h=b[d].stay;a("img.star, .view",e.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});a(e.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});e.imgMove();e.viewCrop();a(".caption",e.elem).hide();var k=null;"caption"in b[d]&&(k=b[d].caption,"min"!=e.options.style||null!=e.options.style)&&(a(".caption",e.elem).show(),e.setCaption(k));d++;setTimeout(function(){e.sequence(b,
...
jQuery.fn.transLength=function(){var a=jQuery(this).css("transition").match(/ [\d|\.]+s/g);return 1E3*Number(a[0].replace("s",""))};String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};String.prototype.splice=function(a,c){return this.slice(0,Math.abs(c))+a+this.slice(Math.abs(c))};String.prototype.stripTags=function(){return this.replace(/<\/?[^>]+(>|$)/g,"")};String.prototype.oneSpace=function(){return this.replace(/\s{2,}/g," ")};
String.prototype.alphaSpaceOnly=function(){return this.replace(/[^\w\s]/gi,"")};String.prototype.alphaOnly=function(){return this.replace(/[^\w]/gi,"")};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.repeat=function(a){return Array(a+1).join(this)};String.prototype.occurs=function(a,c){if(void 0==a)return this.length;a+="";if(0>=a.length)return this.length;for(var b=0,f=0,d=c?1:a.length;;)if(f=this.indexOf(a,f),0<=f)b++,f+=d;else break;return b};
String.prototype.positions=function(a,c,b,f){a+="";var d=0;c=c?1:a.length;for(var e=[];;){var g=!0,d=this.indexOf(a,d);if(0<=d){if(!0==b)for(var h=d;h<this.length&&"<"!=this[h];h++)">"==this[h]&&(g=!1);!0==f&&!0==this.substr(d-1,d+a.length+1).isAlphaNum()&&(g=!1);!0==g&&e.push(d);d+=c}else break}return e};String.prototype.insertAt=function(a,c){return this.substr(0,a)+c+this.substr(a)};
...
String.prototype.isAlphaNum=function(){return/[^a-zA-Z0-9]/.test(this)?!1:!0};String.prototype.sentences=function(){for(var a=this.match(/[^\.!\?]+[\.!\?]+/g),c="aeiouy".split(""),b=[],f="",d=0;d<a.length;d++){for(var e=f+a[d],f="",g=!0,h=0;h<c.length;h++)if(-1!=e.indexOf(c[h])){g=!1;break}e.trim()[0].hasUpper()||(g=!0);g?0<b.length?b[b.length-1]+=e:f=e:b.push(e.smoosh().trim())}return b};function TimeStamp(){}
