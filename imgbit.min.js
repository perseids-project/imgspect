...
a(b.elem).after('<div class="imgbit">');b.elem=a(b.elem).next();a(b.elem).attr("id",c);var c=a(b.elem).prev(),d=c.html();c.remove();null!=b.options.style&&a(b.elem).addClass(b.options.style);a(b.elem).append('<div class="view">');null!=b.options.style&&a(b.elem).append('<div class="text">'+d+"</div>");var e=new Image;e.onload=function(){a(this).addClass("star");b.imgWidth=e.width;b.imgHeight=e.height;a(".view",b.elem).append(this);b.viewCrop();b.imgMove();a(b.elem).prepend('<div style="clear:both"></div>');
...
String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};function TimeStamp(){}TimeStamp.prototype.withUtc=function(){var a=new Date,c=a.getFullYear(),b=("0"+(a.getMonth()+1)).slice(-2),f=("0"+a.getDate()).slice(-2),d=a.getHours(),e=("0"+a.getMinutes()).slice(-2),g=("0"+a.getSeconds()).slice(-2),a=a.getTimezoneOffset(),c=c+"-"+b+"-"+f+"T"+d+":"+e+":"+g+"UTC";return 0<a?c+"+"+a:c+"-"+a};
function Culuh(a){this.v=this.s=this.h=this.b=this.g=this.r=0;void 0!=a&&(this.original=a,this.reset(),this.hsvUpdate())}Culuh.prototype.reset=function(){var a=this.original,a=a.toUpperCase();-1<a.indexOf("RGB")?(a=a.match(/\d+\.?\d*/g),this.r=parseInt(a[0]),this.g=parseInt(a[1]),this.b=parseInt(a[2])):(a=a.match(/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i),this.r=this.hexToInt(a[1]),this.g=this.hexToInt(a[2]),this.b=this.hexToInt(a[3]))};
