...
!0);this.build()};c.prototype.build=function(){var b=this,c=a(b.elem).attr("id");a(b.elem).after('<div class="imgbit">');b.elem=a(b.elem).next();a(b.elem).attr("id",c);var c=a(b.elem).prev(),d=c.html();c.remove();null!=b.options.style&&a(b.elem).addClass(b.options.style);a(b.elem).append('<div class="view">');a(b.elem).append('<div class="text">'+d+"</div>");a(".text",b.elem).hide();null!=b.options.style&&a(".text",b.elem).show();var e=new Image;e.onload=function(){a(this).addClass("star");b.imgWidth=
e.width;b.imgHeight=e.height;a(".view",b.elem).append(this);b.viewCrop();b.imgMove();a(b.elem).prepend('<div style="clear:both"></div>');null!=b.options.style&&"edit"!=b.options.style&&a(b.elem).prepend('<a class="source" href="'+b.src+'">source</a>');a(b.elem).css({width:a(".view",b.elem).width()});b.editStart();!0==b.options.closable&&b.closeBuild();void 0!=b.param.c&&(a(b.elem).css({"background-color":"#"+b.param.c}),a(".close",b.elem).css({"background-color":"#"+b.param.c}));a(b.elem).trigger(b.events.change)};
e.src=b.src};c.prototype.closeBuild=function(){var b=this;a(b.elem).prepend('<a href="" class="close">x</a>');a(".close",b.elem).click(function(c){a(b.elem).trigger(b.events.closed);a(b.elem).trigger(b.events.change);c.preventDefault()})};c.prototype.captionResize=function(){var b=a(".text",this.elem),c=!1;!1==b.is(":visible")&&(c=!0);b.show();var d=b.height();!0==c&&b.hide();b=parseInt(b.css("font-size").replace("px",""));d=d>b?d:b;a(".caption",this.elem).height(d)};c.prototype.editStart=function(){var b=
this;"edit"==b.options.style&&(b.editBuild(),b.captionResize(),a(".caption",b.elem).keypress(function(a){13==a.which&&b.editSwitch()}),a(".caption",b.elem).bind("input propertychange",function(){b.setCaption(a(".caption",b.elem).val())}))};c.prototype.remove=function(){a(this.elem).remove()};c.prototype.setCaption=function(b){this.caption=b;a(".text",this.elem).text(this.caption);this.captionResize();a(this.elem).trigger(this.events.change)};c.prototype.idUpdate=function(b){a(this.elem).attr("id",
b)};c.prototype.editBuild=function(){var b=this,c='<textarea class="caption">'+a(".text",b.elem).text()+"</textarea>";a(".text",b.elem).after(c);a(".caption",b.elem).css({width:a(".view",b.elem).width()});void 0!=b.culuh&&a(".caption",b.elem).css({"background-color":b.culuh.sat(0.35,!0).hex()});a(".caption",b.elem).hide();a(".text",b.elem).on("touchstart click",function(a){a.preventDefault();b.editSwitch()});a(document).on("touchstart click",function(c){a(c.target).html()!=a(".caption",b.elem).html()&&
a(c.target).html()!=a(".text",b.elem).html()&&b.editHide()})};c.prototype.editSwitch=function(){a(".caption",this.elem).is(":visible")?this.editHide():(c.prototype.editHide(),this.editShow())};c.prototype.editHide=function(){a(".caption",this.elem).hide();a(".text",this.elem).show()};c.prototype.editShow=function(){a(".text",this.elem).hide();a(".caption",this.elem).show();a(".caption",this.elem).cursorToEnd()};c.prototype.viewCrop=function(){a(".view",this.elem).css({width:(this.param.x2-this.param.x1)*
this.param.z,height:(this.param.y2-this.param.y1)*this.param.z});a(this.elem).css({width:(this.param.x2-this.param.x1)*this.param.z})};c.prototype.imgMove=function(){a("img.star",this.elem).css({width:this.imgWidth*this.param.z,height:this.imgHeight*this.param.z,left:-1*this.param.x1*this.param.z,top:-1*this.param.y1*this.param.z})};c.prototype.sequence=function(b,c,d){var e=this;d=void 0!=d?d:0;c=void 0==c?!1:c;if(b.length<=d)!0==c&&e.sequence(b,c,0);else{e.param.x1=b[d].coords[0];e.param.y1=b[d].coords[1];
e.param.x2=b[d].coords[2]+e.param.x1;e.param.y2=b[d].coords[3]+e.param.y1;e.param.z=b[d].coords[4];var g=void 0==b[d].wipe?1:b[d].wipe,h=void 0==b[d].stay?5:b[d].stay;a("img.star, .view",e.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});a(e.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});e.imgMove();e.viewCrop();a(".caption",e.elem).hide();var k=null;"caption"in b[d]&&(k=b[d].caption,"min"!=e.options.style||null!=e.options.style)&&(a(".caption",e.elem).show(),
e.setCaption(k));d++;setTimeout(function(){e.sequence(b,c,d)},1E3*(h+g));a(e.elem).trigger(e.events.frame,{caption:k})}};c.prototype.getToJson=function(a){if(""==a||void 0==a)return{};var c={};a=a.split("%");for(var d=0,e=a.length;d<e;d++){var g=a[d].split("=");2==g.length&&(c[g[0]]=decodeURIComponent(g[1].replace(/\+/g,"")))}return c};c.prototype.html=function(){var a=-1==this.src.indexOf("?")?"?":"&";return('<a class="imgbit" \t\t\t\t\t\thref="'+this.src+"\t\t\t\t\t\t"+a+"imgbit=\t\t\t\t\t\tx1="+
this.param.x1+"\t\t\t\t\t\t%y1="+this.param.y1+"\t\t\t\t\t\t%x2="+this.param.x2+"\t\t\t\t\t\t%y2="+this.param.y2+"\t\t\t\t\t\t%c="+this.param.c+"\t\t\t\t\t\t%z="+this.param.z+'">\t\t\t\t\t\t'+this.caption+"\t\t\t\t\t<a>").smoosh()};c.prototype.sequenceFormat=function(){var a=parseInt(this.param.x1),c=parseInt(this.param.y1),d=parseInt(this.param.x2)-parseInt(this.param.x1),e=parseInt(this.param.y2)-parseInt(this.param.y1);return{coords:[a,c,d,e,this.param.z],caption:this.caption}};c.prototype.citeCoords=
function(){var a=[];a[0]=this.param.x1/this.imgWidth;a[1]=this.param.y1/this.imgHeight;a[2]=(this.param.x2-this.param.x1)/this.imgWidth;a[3]=(this.param.y2-this.param.y1)/this.imgHeight;for(var c=0,d=a.length;c<d;c++)a[c]=a[c].toFixed(4);return a};c.prototype.toJsonLD=function(a){return{"@context":"http://www.w3.org/ns/oa-context-20130208.json","@type":"oa:Annotation",annotatedAt:this.timeCreated,annotatedBy:{"@type":"foaf:Person"},motivatedBy:"perseus:transcribing",label:"isQuotationOf"}};jQuery(document).ready(function(a){jQuery.fn.imgbit=
function(a){var b=jQuery(this).selector;return this.each(function(){jQuery.data(this,b,new c(this,a,b))})}})})(jQuery);jQuery.fn.cursorToEnd=function(){return this.each(function(){jQuery(this).focus();if(this.setSelectionRange){var a=2*jQuery(this).val().length;this.setSelectionRange(a,a)}else jQuery(this).val(jQuery(this).val());this.scrollTop=999999})};jQuery.fn.myHtml=function(){return jQuery(this).clone().wrap("<div>").parent().html()};
jQuery.fn.transLength=function(){var a=jQuery(this).css("transition").match(/ [\d|\.]+s/g);return 1E3*Number(a[0].replace("s",""))};String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};String.prototype.alphaSpaceOnly=function(){return this.replace(/[^\w\s]/gi,"")};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.repeat=function(a){return Array(a+1).join(this)};
String.prototype.occurs=function(a,c){if(void 0==a)return this.length;a+="";if(0>=a.length)return this.length;for(var b=0,f=0,d=c?1:a.length;;)if(f=this.indexOf(a,f),0<=f)b++,f+=d;else break;return b};String.prototype.params=function(){for(var a=this.split("?"),a=a[1].split("&"),c={},b=0,f=a.length;b<f;b++)if(void 0!=a[b]){var d=a[b].split("=");c[d[0]]=d[1]}return c};String.prototype.hasUpper=function(){return/[A-Z]/.test(this)};
String.prototype.report=function(){for(var a=this.toLowerCase().split(" "),c={},b=0,f=a.length;b<f;b++){var d=a[b];c[d]=d in c?c[d]+1:1}return c};String.prototype.lines=function(){return this.split("\n")};String.prototype.sentences=function(){for(var a=this.match(/[^\.!\?]+[\.!\?]+/g),c="aeiouy".split(""),b=[],f="",d=0;d<a.length;d++){for(var e=f+a[d],f="",g=!0,h=0;h<c.length;h++)if(-1!=e.indexOf(c[h])){g=!1;break}e.trim()[0].hasUpper()||(g=!0);g?0<b.length?b[b.length-1]+=e:f=e:b.push(e.smoosh().trim())}return b};
function TimeStamp(){}TimeStamp.prototype.withUtc=function(a){var c=new Date,b=c.getFullYear(),f=("0"+(c.getMonth()+1)).slice(-2),d=("0"+c.getDate()).slice(-2),e=c.getHours(),g=("0"+c.getMinutes()).slice(-2),h=("0"+c.getSeconds()).slice(-2),k=("0"+c.getMilliseconds()).slice(-3),c=c.getTimezoneOffset(),l="",l=a?b+"-"+f+"-"+d+"T"+e+":"+g+":"+h+":"+k+"UTC":b+"-"+f+"-"+d+"T"+e+":"+g+":"+h+"UTC";return 0<c?l+"+"+c:l+"-"+c};TimeStamp.prototype.unix=function(){return(new Date).getTime()};
