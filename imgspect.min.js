(function(b){function c(a,b){if(!(1<a.originalEvent.touches.length)){a.preventDefault();var c=a.originalEvent.changedTouches[0],d=document.createEvent("MouseEvents");d.initMouseEvent(b,!0,!0,window,1,c.screenX,c.screenY,c.clientX,c.clientY,!1,!1,!1,!1,0,null);a.target.dispatchEvent(d)}}b.support.touch="ontouchend"in document;if(b.support.touch){var a=b.ui.mouse.prototype,d=a._mouseInit,e;a._touchStart=function(a){!e&&this._mouseCapture(a.originalEvent.changedTouches[0])&&(e=!0,this._touchMoved=!1,
c(a,"mouseover"),c(a,"mousemove"),c(a,"mousedown"))};a._touchMove=function(a){e&&(this._touchMoved=!0,c(a,"mousemove"))};a._touchEnd=function(a){e&&(c(a,"mouseup"),c(a,"mouseout"),this._touchMoved||c(a,"click"),e=!1)};a._mouseInit=function(){this.element.bind("touchstart",b.proxy(this,"_touchStart")).bind("touchmove",b.proxy(this,"_touchMove")).bind("touchend",b.proxy(this,"_touchEnd"));d.call(this)}}})(jQuery);
jQuery.fn.cursorToEnd=function(){return this.each(function(){$(this).focus();if(this.setSelectionRange){var b=2*$(this).val().length;this.setSelectionRange(b,b)}else $(this).val($(this).val());this.scrollTop=999999})};jQuery.fn.myHtml=function(){return $(this).clone().wrap("<div>").parent().html()};jQuery.fn.transLength=function(){var b=$(this).css("transition").match(/ [\d|\.]+s/g);return 1E3*Number(b[0].replace("s",""))};
String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};String.prototype.occurs=function(b,c){if(void 0==b)return this.length;b+="";if(0>=b.length)return this.length;for(var a=0,d=0,e=c?1:b.length;;)if(d=this.indexOf(b,d),0<=d)a++,d+=e;else break;return a};String.prototype.params=function(){for(var b=this.split("?"),b=b[1].split("&"),c={},a=0,d=b.length;a<d;a++)if(void 0!=b[a]){var e=b[a].split("=");c[e[0]]=e[1]}return c};String.prototype.hasUpper=function(){return/[A-Z]/.test(this)};
String.prototype.report=function(){for(var b=this.toLowerCase().split(" "),c={},a=0,d=b.length;a<d;a++){var e=b[a];c[e]=e in c?c[e]+1:1}return c};String.prototype.lines=function(){return this.split("\n")};String.prototype.sentences=function(){for(var b=this.match(/[^\.!\?]+[\.!\?]+/g),c="aeiouy".split(""),a=[],d="",e=0;e<b.length;e++){for(var f=d+b[e],d="",g=!0,k=0;k<c.length;k++)if(-1!=f.indexOf(c[k])){g=!1;break}f.trim()[0].hasUpper()||(g=!0);g?0<a.length?a[a.length-1]+=f:d=f:a.push(f.smoosh().trim())}return a};
...
MDT:"-0700",PDT:"-0800"}};Date.getMonthNumberFromName=function(b){var c=Date.CultureInfo.monthNames,a=Date.CultureInfo.abbreviatedMonthNames;b=b.toLowerCase();for(var d=0;d<c.length;d++)if(c[d].toLowerCase()==b||a[d].toLowerCase()==b)return d;return-1};Date.getDayNumberFromName=function(b){var c=Date.CultureInfo.dayNames,a=Date.CultureInfo.abbreviatedDayNames;b=b.toLowerCase();for(var d=0;d<c.length;d++)if(c[d].toLowerCase()==b||a[d].toLowerCase()==b)return d;return-1};
...
Date.getTimezoneAbbreviation=function(b,c){var a=c?Date.CultureInfo.abbreviatedTimeZoneDST:Date.CultureInfo.abbreviatedTimeZoneStandard,d;for(d in a)if(a[d]===b)return d;return null};Date.prototype.clone=function(){return new Date(this.getTime())};Date.prototype.compareTo=function(b){if(isNaN(this))throw Error(this);if(b instanceof Date&&!isNaN(b))return this>b?1:this<b?-1:0;throw new TypeError(b);};Date.prototype.equals=function(b){return 0===this.compareTo(b)};
...
Date.prototype.getWeekOfYear=function(b){var c=this.getFullYear(),a=this.getMonth(),d=this.getDate();b=b||Date.CultureInfo.firstDayOfWeek;var e=8-(new Date(c,0,1)).getDay();8==e&&(e=1);a=(Date.UTC(c,a,d,0,0,0)-Date.UTC(c,0,1,0,0,0))/864E5+1;a=Math.floor((a-e+7)/7);a===b&&(c--,c=8-(new Date(c,0,1)).getDay(),a=2==c||8==c?53:52);return a};Date.prototype.isDST=function(){console.log("isDST");return"D"==this.toString().match(/(E|C|M|P)(S|D)T/)[2]};
...
(this._is=!1,this.getMonth()===a):this.moveToMonth(a,this._orient)}};for(f=0;f<d.length;f++)b[d[f]]=b[d[f].substring(0,3)]=a(f);a=function(a){return function(){"s"!=a.substring(a.length-1)&&(a+="s");return this["add"+a](this._orient)}};f=function(a){return function(){this._dateElement=a;return this}};for(g=0;g<e.length;g++)d=e[g].toLowerCase(),b[d]=b[d+"s"]=a(e[g]),c[d]=c[d+"s"]=f(d)})();Date.prototype.toJSONString=function(){return this.toString("yyyy-MM-ddThh:mm:ssZ")};
...
(function(){Date.Parsing={Exception:function(a){this.message="Parse error at '"+a.substring(0,10)+" ...'"}};for(var b=Date.Parsing,c=b.Operators={rtoken:function(a){return function(c){var d=c.match(a);if(d)return[d[0],c.substring(d[0].length)];throw new b.Exception(c);}},token:function(a){return function(a){return c.rtoken(RegExp("^s*"+a+"s*"))(a)}},stoken:function(a){return c.rtoken(RegExp("^"+a))},until:function(a){return function(b){for(var c=[],d=null;b.length;){try{d=a.call(this,b)}catch(e){c.push(d[0]);
b=d[1];continue}break}return[c,b]}},many:function(a){return function(b){for(var c=[],d=null;b.length;){try{d=a.call(this,b)}catch(e){break}c.push(d[0]);b=d[1]}return[c,b]}},optional:function(a){return function(b){var c=null;try{c=a.call(this,b)}catch(d){return[null,b]}return[c[0],c[1]]}},not:function(a){return function(c){try{a.call(this,c)}catch(d){return[null,c]}throw new b.Exception(c);}},ignore:function(a){return a?function(b){var c=null,c=a.call(this,b);return[null,c[1]]}:null},product:function(){for(var a=
arguments[0],b=Array.prototype.slice.call(arguments,1),d=[],e=0;e<a.length;e++)d.push(c.each(a[e],b));return d},cache:function(a){var c={},d=null;return function(e){try{d=c[e]=c[e]||a.call(this,e)}catch(h){d=c[e]=h}if(d instanceof b.Exception)throw d;return d}},any:function(){var a=arguments;return function(c){for(var d=null,e=0;e<a.length;e++)if(null!=a[e]){try{d=a[e].call(this,c)}catch(h){d=null}if(d)return d}throw new b.Exception(c);}},each:function(){var a=arguments;return function(c){for(var d=
[],e=null,h=0;h<a.length;h++)if(null!=a[h]){try{e=a[h].call(this,c)}catch(l){throw new b.Exception(c);}d.push(e[0]);c=e[1]}return[d,c]}},all:function(){var a=a;return a.each(a.optional(arguments))},sequence:function(a,d,e){d=d||c.rtoken(/^\s*/);e=e||null;return 1==a.length?a[0]:function(c){for(var h=null,l=null,n=[],p=0;p<a.length;p++){try{h=a[p].call(this,c)}catch(q){break}n.push(h[0]);try{l=d.call(this,h[1])}catch(s){l=null;break}c=l[1]}if(!h)throw new b.Exception(c);if(l)throw new b.Exception(l[1]);
if(e)try{h=e.call(this,h[1])}catch(t){throw new b.Exception(h[1]);}return[n,h?h[1]:c]}},between:function(a,b,d){d=d||a;var e=c.each(c.ignore(a),b,c.ignore(d));return function(a){a=e.call(this,a);return[[a[0][0],r[0][2]],a[1]]}},list:function(a,b,d){b=b||c.rtoken(/^\s*/);d=d||null;return a instanceof Array?c.each(c.product(a.slice(0,-1),c.ignore(b)),a.slice(-1),c.ignore(d)):c.each(c.many(c.each(a,c.ignore(b))),px,c.ignore(d))},set:function(a,d,e){d=d||c.rtoken(/^\s*/);e=e||null;return function(m){for(var h=
null,l=h=null,n=null,p=[[],m],q=!1,s=0;s<a.length;s++){h=l=null;q=1==a.length;try{h=a[s].call(this,m)}catch(t){continue}n=[[h[0]],h[1]];if(0<h[1].length&&!q)try{l=d.call(this,h[1])}catch(u){q=!0}else q=!0;q||0!==l[1].length||(q=!0);if(!q){h=[];for(q=0;q<a.length;q++)s!=q&&h.push(a[q]);h=c.set(h,d).call(this,l[1]);0<h[0].length&&(n[0]=n[0].concat(h[0]),n[1]=h[1])}n[1].length<p[1].length&&(p=n);if(0===p[1].length)break}if(0===p[0].length)return p;if(e){try{l=e.call(this,p[1])}catch(v){throw new b.Exception(p[1]);
}p[1]=l[1]}return p}},forward:function(a,b){return function(c){return a[b].call(this,c)}},replace:function(a,b){return function(c){c=a.call(this,c);return[b,c[1]]}},process:function(a,b){return function(c){c=a.call(this,c);return[b.call(this,c[0]),c[1]]}},min:function(a,c){return function(d){var e=c.call(this,d);if(e[0].length<a)throw new b.Exception(d);return e}}},a=function(a){return function(){var b=null,c=[];1<arguments.length?b=Array.prototype.slice.call(arguments):arguments[0]instanceof Array&&
(b=arguments[0]);if(b)for(var d=b.shift();0<d.length;)return b.unshift(d[0]),c.push(a.apply(null,b)),b.shift(),c;else return a.apply(null,arguments)}},d="optional not ignore cache".split(/\s/),e=0;e<d.length;e++)c[d[e]]=a(c[d[e]]);a=function(a){return function(){return arguments[0]instanceof Array?a.apply(null,arguments[0]):a.apply(null,arguments)}};d="each any all".split(/\s/);for(e=0;e<d.length;e++)c[d[e]]=a(c[d[e]])})();
...
a.getDay()).getDate());this.month&&!this.day&&(this.day=1);return a.set(this)}};var c=Date.Parsing.Operators,a=Date.Grammar,d=Date.Translator,e;a.datePartDelimiter=c.rtoken(/^([\s\-\.\,\/\x27]+)/);a.timePartDelimiter=c.stoken(":");a.whiteSpace=c.rtoken(/^\s*/);a.generalDelimiter=c.rtoken(/^(([\s\,]|at|on)+)/);var f={};a.ctoken=function(a){var b=f[a];if(!b){for(var b=Date.CultureInfo.regexPatterns,d=a.split(/\s+/),e=[],g=0;g<d.length;g++)e.push(c.replace(c.rtoken(b[d[g]]),d[g]));b=f[a]=c.any.apply(null,
e)}return b};a.ctoken2=function(a){return c.rtoken(Date.CultureInfo.regexPatterns[a])};a.h=c.cache(c.process(c.rtoken(/^(0[0-9]|1[0-2]|[1-9])/),d.hour));a.hh=c.cache(c.process(c.rtoken(/^(0[0-9]|1[0-2])/),d.hour));a.H=c.cache(c.process(c.rtoken(/^([0-1][0-9]|2[0-3]|[0-9])/),d.hour));a.HH=c.cache(c.process(c.rtoken(/^([0-1][0-9]|2[0-3])/),d.hour));a.m=c.cache(c.process(c.rtoken(/^([0-5][0-9]|[0-9])/),d.minute));a.mm=c.cache(c.process(c.rtoken(/^[0-5][0-9]/),d.minute));a.s=c.cache(c.process(c.rtoken(/^([0-5][0-9]|[0-9])/),
d.second));a.ss=c.cache(c.process(c.rtoken(/^[0-5][0-9]/),d.second));a.hms=c.cache(c.sequence([a.H,a.mm,a.ss],a.timePartDelimiter));a.t=c.cache(c.process(a.ctoken2("shortMeridian"),d.meridian));a.tt=c.cache(c.process(a.ctoken2("longMeridian"),d.meridian));a.z=c.cache(c.process(c.rtoken(/^(\+|\-)?\s*\d\d\d\d?/),d.timezone));a.zz=c.cache(c.process(c.rtoken(/^(\+|\-)\s*\d\d\d\d/),d.timezone));a.zzz=c.cache(c.process(a.ctoken2("timezone"),d.timezone));a.timeSuffix=c.each(c.ignore(a.whiteSpace),c.set([a.tt,
a.zzz]));a.time=c.each(c.optional(c.ignore(c.stoken("T"))),a.hms,a.timeSuffix);a.d=c.cache(c.process(c.each(c.rtoken(/^([0-2]\d|3[0-1]|\d)/),c.optional(a.ctoken2("ordinalSuffix"))),d.day));a.dd=c.cache(c.process(c.each(c.rtoken(/^([0-2]\d|3[0-1])/),c.optional(a.ctoken2("ordinalSuffix"))),d.day));a.ddd=a.dddd=c.cache(c.process(a.ctoken("sun mon tue wed thu fri sat"),function(a){return function(){this.weekday=a}}));a.M=c.cache(c.process(c.rtoken(/^(1[0-2]|0\d|\d)/),d.month));a.MM=c.cache(c.process(c.rtoken(/^(1[0-2]|0\d)/),
d.month));a.MMM=a.MMMM=c.cache(c.process(a.ctoken("jan feb mar apr may jun jul aug sep oct nov dec"),d.month));a.y=c.cache(c.process(c.rtoken(/^(\d\d?)/),d.year));a.yy=c.cache(c.process(c.rtoken(/^(\d\d)/),d.year));a.yyy=c.cache(c.process(c.rtoken(/^(\d\d?\d?\d?)/),d.year));a.yyyy=c.cache(c.process(c.rtoken(/^(\d\d\d\d)/),d.year));e=function(){return c.each(c.any.apply(null,arguments),c.not(a.ctoken2("timeContext")))};a.day=e(a.d,a.dd);a.month=e(a.M,a.MMM);a.year=e(a.yyyy,a.yy);a.orientation=c.process(a.ctoken("past future"),
function(a){return function(){this.orient=a}});a.operator=c.process(a.ctoken("add subtract"),function(a){return function(){this.operator=a}});a.rday=c.process(a.ctoken("yesterday tomorrow today now"),d.rday);a.unit=c.process(a.ctoken("minute hour day week month year"),function(a){return function(){this.unit=a}});a.value=c.process(c.rtoken(/^\d\d?(st|nd|rd|th)?/),function(a){return function(){this.value=a.replace(/\D/g,"")}});a.expression=c.set([a.rday,a.operator,a.value,a.unit,a.orientation,a.ddd,
a.MMM]);e=function(){return c.set(arguments,a.datePartDelimiter)};a.mdy=e(a.ddd,a.month,a.day,a.year);a.ymd=e(a.ddd,a.year,a.month,a.day);a.dmy=e(a.ddd,a.day,a.month,a.year);a.date=function(b){return(a[Date.CultureInfo.dateElementOrder]||a.mdy).call(this,b)};a.format=c.process(c.many(c.any(c.process(c.rtoken(/^(dd?d?d?|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|zz?z?)/),function(b){if(a[b])return a[b];throw Date.Parsing.Exception(b);}),c.process(c.rtoken(/^[^dMyhHmstz]+/),function(a){return c.ignore(c.stoken(a))}))),
function(a){return c.process(c.each.apply(null,a),d.finishExact)});var g={},k=function(b){return g[b]=g[b]||a.format(b)[0]};a.formats=function(a){if(a instanceof Array){for(var b=[],d=0;d<a.length;d++)b.push(k(a[d]));return c.any.apply(null,b)}return k(a)};a._formats=a.formats(["yyyy-MM-ddTHH:mm:ss","ddd, MMM dd, yyyy H:mm:ss tt","ddd MMM d yyyy HH:mm:ss zzz","d"]);a._start=c.process(c.set([a.date,a.time,a.expression],a.generalDelimiter,a.whiteSpace),d.finish);a.start=function(b){try{var c=a._formats.call({},
b);if(0===c[1].length)return c}catch(d){}return a._start.call({},b)}})();Date._parse=Date.parse;Date.parse=function(b){var c=null;if(!b)return null;try{c=Date.Grammar.start.call({},b)}catch(a){return null}return 0===c[1].length?c[0]:null};Date.getParseFunction=function(b){var c=Date.Grammar.formats(b);return function(a){var b=null;try{b=c.call({},a)}catch(e){return null}return 0===b[1].length?b[0]:null}};Date.parseExact=function(b,c){return Date.getParseFunction(c)(b)};function TimeStamp(){}
TimeStamp.prototype.withUtc=function(b){var c=new Date,a=c.getFullYear(),d=("0"+(c.getMonth()+1)).slice(-2),e=("0"+c.getDate()).slice(-2),f=c.getHours(),g=("0"+c.getMinutes()).slice(-2),k=("0"+c.getSeconds()).slice(-2),m=("0"+c.getMilliseconds()).slice(-3),c=c.getTimezoneOffset(),h="",h=b?a+"-"+d+"-"+e+"T"+f+":"+g+":"+k+":"+m+"UTC":a+"-"+d+"-"+e+"T"+f+":"+g+":"+k+"UTC";return 0<c?h+"+"+c:h+"-"+c};TimeStamp.prototype.unix=function(){return(new Date).getTime()};
TimeStamp.prototype.toUnix=function(b){b=b.replace(/UTC.*/,"");var c=0;b.match(/:\d{3}/)&&(c=b.slice(-4),b=b.replace(/:\d+$/,""),c=parseInt(c.replace(":","")));return Date.parse(b).getTime()+c};ObjectExt=function(){};ObjectExt.prototype.mergeAdd=function(b,c){for(var a in b)c[a]=a in c?c[a]+b[a]:1};ObjectExt.prototype.totalChars=function(b,c,a){c=void 0==c?0:c;a=void 0==a?0:a;for(var d=0,e=b.length;d<e;d++){if("object"==typeof b[d])return a++,this.totalChars(b[d],c,a);c+=b[d].toString().length}return c};
ObjectExt.prototype.totalKeys=function(b){var c=0,a;for(a in b)b.hasOwnProperty(a)&&c++;return c};ObjectExt.prototype.wrap=function(b,c,a){a=void 0==a?c:a;for(var d=[],e=0,f=b.length;e<f;e++)d[e]=c.toString()+b[e]+a.toString();return d};
ObjectExt.prototype.clone=function(b){if(null==b||"_object"!=typeof b)return b;if(b instanceof Date){var c=new Date;c.setTime(b.getTime());return c}if(b instanceof Array){for(var c=[],a=0,d=b.length;a<d;a++)c[a]=this.clone(b[a]);return c}if(b instanceof Object){c={};for(a in b)b.hasOwnProperty(a)&&(c[a]=this.clone(b[a]));return c}throw Error("Unable to copy obj! Its type isn't supported.");};
ObjectExt.prototype.byString=function(b,c){if(void 0==c)return b;c=c.replace(/\[['|"]*(\w+)['|"]*\]/g,".$1");c=c.replace(/^\./,"");for(var a=c.split(".");a.length;){var d=a.shift();if(d in b)b=b[d];else return}return b};function Culuh(b){this.v=this.s=this.h=this.b=this.g=this.r=0;void 0!=b&&(this.original=b,this.reset(),this.hsvUpdate())}
...
Culuh.prototype.rgbUpdate=function(){var b,c,a,d=this.h/255,e=this.s/255,f=this.v/255;if(0==e)b=c=a=f;else{var d=6*d,g=d%1,k=f*(1-e),m=f*(1-e*g),e=f*(1-e*(1-g));switch(Math.floor(d)){case 0:b=f;c=e;a=k;break;case 1:b=m;c=f;a=k;break;case 2:b=k;c=f;a=e;break;case 3:b=k;c=m;a=f;break;case 4:b=e;c=k;a=f;break;case 5:b=f,c=k,a=m}}this.r=parseInt(255*b);this.g=parseInt(255*c);this.b=parseInt(255*a)};Culuh.prototype.hex=function(b){return(void 0==b?"":b)+this.rHex()+this.gHex()+this.bHex()};
...
function Sorted(){}
Sorted.prototype.areaSort=function(b,c,a,d,e,f){var g=new ObjectExt;e=void 0==e?[]:e;f=void 0==f?0:f;c=void 0==c?"x":c;a=void 0==a?"y1":a;d=void 0==d?"y2":d;e.length-1<f&&(e[f]=[]);if("object"!==typeof b[0])throw"Sorted.areaSort() -- First parameter must be an array of objects";for(var k=0,m=parseInt(g.byString(b[k],a)),h=1,l=b.length;h<l;h++){var n=parseInt(g.byString(b[h],a));n<m&&(m=n,k=h)}h=b.splice(k,1);h=h[0];e[f].push(h);k=parseInt(g.byString(h,a));m=parseInt(g.byString(h,d));for(h=b.length;h--;)n=
parseInt(g.byString(b[h],a)),l=parseInt(g.byString(b[h],d))-n,n+=l/2,n>=k&&n<=m&&(n=b.splice(h,1),n=n[0],e[f].push(n));if(0==b.length){h=0;for(l=e.length;h<l;h++)e[h]=this.numSort(e[h],c);return e}return this.areaSort(b,c,a,d,e,f+1)};Sorted.prototype.numSort=function(b,c){var a=new ObjectExt;return b.sort(function(b,e){var f=Number(a.byString(b,c)),g=Number(a.byString(e,c));return f-g})};
...
b(a.elem).prepend(c);c.css({clear:"both"});c.click(function(b){a.hide();b.preventDefault()});b(document).bind("PLOPUP-POPPED",function(c,d){d!=a.obj.id&&"block"==b(a.elem).css("display")&&b(a.elem).css("top")!=a.obj.HIDDEN&&b(a.elem).css({top:a.obj.HIDDEN})});b("a",document).click(function(c){var d=b(this).attr("href");void 0!=d&&(d=d.replace("#",""),d==a.obj.id&&(a.popup(),c.preventDefault()))})};jQuery(document).ready(function(a){jQuery.fn.plopup=function(a){var b=jQuery(this).selector;return this.each(function(){jQuery.data(this,
...
annotatedBy:{"@type":"foaf:Person"},motivatedBy:"perseus:transcribing",label:"isQuotationOf"}};jQuery(document).ready(function(a){jQuery.fn.imgbit=function(a){var b=jQuery(this).selector;return this.each(function(){jQuery.data(this,b,new c(this,a,b))})}})})(jQuery);
...
function(b){b.preventDefault();a.drawMouseMove(b)});b(a.elem).mouseup(function(b){b.preventDefault();a.drawMouseUp(b)});b(a.elem).bind("touchend",function(b){b.preventDefault();a.drawMouseUp(b)})};c.prototype.liteAdd=function(a,c,e,f){this.lites.push({x1:parseInt(a),y1:parseInt(c),x2:parseInt(e),y2:parseInt(f),zoom:this.zoom_n,color:this.options.lite_color,opacity:this.options.lite_opacity,id:this.lites.length});this.navLiteDraw(this.liteLast().id);this.c_pos=this.c_lite=null;b(this.elem).trigger(this.events.change)};
c.prototype.liteDom=function(){return b(document.createElement("div")).addClass("lite")};c.prototype.navLiteDraw=function(a){try{if(0>a||a>=this.lites.length)throw"out of range";}catch(c){b(this.elem).trigger(this.events.error,{error:c});return}var e=this.liteDom(),f=b(".nav",this.elem);f.append(e);f=f.position();a=this.lites[a];e.css({left:a.x1/this.nav_scale+f.left,top:a.y1/this.nav_scale+f.top,width:a.x2/this.nav_scale-a.x1/this.nav_scale,height:a.y2/this.nav_scale-a.y1/this.nav_scale,"background-color":"#"+
a.color.hex(),opacity:a.opacity})};c.prototype.liteLast=function(){return this.lites[this.lites.length-1]};c.prototype.liteResize=function(){this.liteRedraw()};c.prototype.liteShow=function(a){try{if(0>a||a>=this.lites.length)throw"out of range";}catch(c){b(this.elem).trigger(this.events.error,{error:c});return}var e=this.lites[a];a=e.x1+(e.x2-e.x1)/2;e=e.y1+(e.y2-e.y1)/2;a-=b(".view",this.elem).width()/2/this.zoom_n;e-=b(".view",this.elem).height()/2/this.zoom_n;this.goTo(a,e)};c.prototype.liteRedraw=
