...
f.param.x2=a[d].coords[2];f.param.y2=a[d].coords[3];f.param.z=a[d].coords[4];var g=a[d].wipe,k=a[d].stay;b("img.star, .view",f.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});b(f.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});f.imgMove();f.viewCrop();b(".caption",f.elem).hide();var l=null;"caption"in a[d]&&(l=a[d].caption,"min"!=f.options.style||null!=f.options.style)&&(b(".caption",f.elem).show(),f.setCaption(l));d++;setTimeout(function(){f.sequence(a,
