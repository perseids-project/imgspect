...
String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};String.prototype.occurs=function(b,c){if(void 0==b)return this.length;b+="";if(0>=b.length)return this.length;for(var a=0,e=0,d=c?1:b.length;;)if(e=this.indexOf(b,e),0<=e)a++,e+=d;else break;return a};String.prototype.params=function(){for(var b=this.split("?"),b=b[1].split("&"),c={},a=0,e=b.length;a<e;a++)if(void 0!=b[a]){var d=b[a].split("=");c[d[0]]=d[1]}return c};String.prototype.hasUpper=function(){return/[A-Z]/.test(this)};
...
[],d=null,h=0;h<a.length;h++)if(null!=a[h]){try{d=a[h].call(this,c)}catch(l){throw new b.Exception(c);}e.push(d[0]);c=d[1]}return[e,c]}},all:function(){var a=a;return a.each(a.optional(arguments))},sequence:function(a,e,d){e=e||c.rtoken(/^\s*/);d=d||null;return 1==a.length?a[0]:function(c){for(var h=null,l=null,n=[],p=0;p<a.length;p++){try{h=a[p].call(this,c)}catch(q){break}n.push(h[0]);try{l=e.call(this,h[1])}catch(s){l=null;break}c=l[1]}if(!h)throw new b.Exception(c);if(l)throw new b.Exception(l[1]);
if(d)try{h=d.call(this,h[1])}catch(t){throw new b.Exception(h[1]);}return[n,h?h[1]:c]}},between:function(a,b,e){e=e||a;var d=c.each(c.ignore(a),b,c.ignore(e));return function(a){a=d.call(this,a);return[[a[0][0],r[0][2]],a[1]]}},list:function(a,b,e){b=b||c.rtoken(/^\s*/);e=e||null;return a instanceof Array?c.each(c.product(a.slice(0,-1),c.ignore(b)),a.slice(-1),c.ignore(e)):c.each(c.many(c.each(a,c.ignore(b))),px,c.ignore(e))},set:function(a,e,d){e=e||c.rtoken(/^\s*/);d=d||null;return function(m){for(var h=
null,l=h=null,n=null,p=[[],m],q=!1,s=0;s<a.length;s++){h=l=null;q=1==a.length;try{h=a[s].call(this,m)}catch(t){continue}n=[[h[0]],h[1]];if(0<h[1].length&&!q)try{l=e.call(this,h[1])}catch(u){q=!0}else q=!0;q||0!==l[1].length||(q=!0);if(!q){h=[];for(q=0;q<a.length;q++)s!=q&&h.push(a[q]);h=c.set(h,e).call(this,l[1]);0<h[0].length&&(n[0]=n[0].concat(h[0]),n[1]=h[1])}n[1].length<p[1].length&&(p=n);if(0===p[1].length)break}if(0===p[0].length)return p;if(d){try{l=d.call(this,p[1])}catch(v){throw new b.Exception(p[1]);
...
Culuh.prototype.rgbUpdate=function(){var b,c,a,e=this.h/255,d=this.s/255,f=this.v/255;if(0==d)b=c=a=f;else{var e=6*e,g=e%1,k=f*(1-d),m=f*(1-d*g),d=f*(1-d*(1-g));switch(Math.floor(e)){case 0:b=f;c=d;a=k;break;case 1:b=m;c=f;a=k;break;case 2:b=k;c=f;a=d;break;case 3:b=k;c=m;a=f;break;case 4:b=d;c=k;a=f;break;case 5:b=f,c=k,a=m}}this.r=parseInt(255*b);this.g=parseInt(255*c);this.b=parseInt(255*a)};Culuh.prototype.hex=function(b){return(void 0==b?"":b)+this.rHex()+this.gHex()+this.bHex()};
...
function(){var a=this,c=b(a.elem).attr("id");b(a.elem).after('<div class="imgbit">');a.elem=b(a.elem).next();b(a.elem).attr("id",c);var c=b(a.elem).prev(),d=c.html();c.remove();null!=a.options.style&&b(a.elem).addClass(a.options.style);b(a.elem).append('<div class="view">');b(a.elem).append('<div class="text">'+d+"</div>");b(".text",a.elem).hide();null!=a.options.style&&b(".text",a.elem).show();var f=new Image;f.onload=function(){b(this).addClass("star");a.imgWidth=f.width;a.imgHeight=f.height;b(".view",
a.elem).append(this);a.viewCrop();a.imgMove();b(a.elem).prepend('<div style="clear:both"></div>');null!=a.options.style&&"edit"!=a.options.style&&b(a.elem).prepend('<a class="source" href="'+a.src+'">source</a>');b(a.elem).css({width:b(".view",a.elem).width()});a.editStart();!0==a.options.closable&&a.closeBuild();void 0!=a.param.c&&(b(a.elem).css({"background-color":"#"+a.param.c}),b(".close",a.elem).css({"background-color":"#"+a.param.c}));b(a.elem).trigger(a.events.change)};f.src=a.src};c.prototype.closeBuild=
function(){var a=this;b(a.elem).prepend('<a href="" class="close">x</a>');b(".close",a.elem).click(function(c){b(a.elem).trigger(a.events.closed);b(a.elem).trigger(a.events.change);c.preventDefault()})};c.prototype.captionResize=function(){var a=b(".text",this.elem),c=!1;!1==a.is(":visible")&&(c=!0);a.show();var d=a.height();!0==c&&a.hide();a=parseInt(a.css("font-size").replace("px",""));d=d>a?d:a;b(".caption",this.elem).height(d)};c.prototype.editStart=function(){var a=this;"edit"==a.options.style&&
(a.editBuild(),a.captionResize(),b(".caption",a.elem).keypress(function(b){13==b.which&&a.editSwitch()}),b(".caption",a.elem).bind("input propertychange",function(){a.setCaption(b(".caption",a.elem).val())}))};c.prototype.remove=function(){b(this.elem).remove()};c.prototype.setCaption=function(a){this.caption=a;b(".text",this.elem).text(this.caption);this.captionResize();b(this.elem).trigger(this.events.change)};c.prototype.idUpdate=function(a){b(this.elem).attr("id",a)};c.prototype.editBuild=function(){var a=
this,c='<textarea class="caption">'+b(".text",a.elem).text()+"</textarea>";b(".text",a.elem).after(c);b(".caption",a.elem).css({width:b(".view",a.elem).width()});void 0!=a.culuh&&b(".caption",a.elem).css({"background-color":a.culuh.sat(0.35,!0).hex()});b(".caption",a.elem).hide();b(".text",a.elem).on("touchstart click",function(b){b.preventDefault();a.editSwitch()});b(document).on("touchstart click",function(c){b(c.target).html()!=b(".caption",a.elem).html()&&b(c.target).html()!=b(".text",a.elem).html()&&
a.editHide()})};c.prototype.editSwitch=function(){b(".caption",this.elem).is(":visible")?this.editHide():(c.prototype.editHide(),this.editShow())};c.prototype.editHide=function(){b(".caption",this.elem).hide();b(".text",this.elem).show()};c.prototype.editShow=function(){b(".text",this.elem).hide();b(".caption",this.elem).show();b(".caption",this.elem).cursorToEnd()};c.prototype.viewCrop=function(){b(".view",this.elem).css({width:(this.param.x2-this.param.x1)*this.param.z,height:(this.param.y2-this.param.y1)*
this.param.z});b(this.elem).css({width:(this.param.x2-this.param.x1)*this.param.z})};c.prototype.imgMove=function(){b("img.star",this.elem).css({width:this.imgWidth*this.param.z,height:this.imgHeight*this.param.z,left:-1*this.param.x1*this.param.z,top:-1*this.param.y1*this.param.z})};c.prototype.sequence=function(a,c,d){var f=this;d=void 0!=d?d:0;c=void 0==c?!1:c;if(a.length<=d)!0==c&&f.sequence(a,c,0);else{f.param.x1=a[d].coords[0];f.param.y1=a[d].coords[1];f.param.x2=a[d].coords[2];f.param.y2=a[d].coords[3];
f.param.z=a[d].coords[4];var g=a[d].wipe,k=a[d].stay;b("img.star, .view",f.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});b(f.elem).css({transition:"all "+g+"s","-webkit-transition":"all "+g+"s"});f.imgMove();f.viewCrop();b(".text",f.elem).hide();"caption"in a[d]&&(b(".text",f.elem).show(),f.setCaption(a[d].caption));d++;setTimeout(function(){f.sequence(a,c,d)},1E3*(k+g))}};c.prototype.getToJson=function(a){if(""==a||void 0==a)return{};var b={};a=a.split("%");for(var c=0,f=
a.length;c<f;c++){var g=a[c].split("=");2==g.length&&(b[g[0]]=decodeURIComponent(g[1].replace(/\+/g,"")))}return b};c.prototype.html=function(){var a=-1==this.src.indexOf("?")?"?":"&";return('<a class="imgbit" \t\t\t\t\t\thref="'+this.src+"\t\t\t\t\t\t"+a+"imgbit=\t\t\t\t\t\tx1="+this.param.x1+"\t\t\t\t\t\t%y1="+this.param.y1+"\t\t\t\t\t\t%x2="+this.param.x2+"\t\t\t\t\t\t%y2="+this.param.y2+"\t\t\t\t\t\t%c="+this.param.c+"\t\t\t\t\t\t%z="+this.param.z+'">\t\t\t\t\t\t'+this.caption+"\t\t\t\t\t<a>").smoosh()};
...
jQuery(document).ready(function(a){jQuery.fn.imgbit=function(a){var b=jQuery(this).selector;return this.each(function(){jQuery.data(this,b,new c(this,a,b))})}})})(jQuery);
