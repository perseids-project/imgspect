...
function(a){var e=this;b("#drop #imgbit-"+a+" .view").click(function(a){e.drop.close();var c=b(this).parent().attr("id"),g=parseInt(c.replace("imgbit-",""));setTimeout(function(){e.liteShow(g)},500);a.preventDefault()});b("#drop #imgbit-"+a).on("IMGBIT-CHANGE",function(){e.outputUpdate()});b("#drop #imgbit-"+a).on("IMGBIT-CLOSED",function(){e.liteRemove(a)})};c.prototype.outputBuild=function(){b(".tools",this.elem).append('<div class="output"><pre></pre></div>');b(".output",this.elem).css({"max-height":b(".nav",
...
a.editSwitch()}),b(".caption",a.elem).bind("input propertychange",function(){a.caption=b(".caption",a.elem).val();b(".text",a.elem).text(a.caption);a.captionResize();b(a.elem).trigger(a.events.change)}))};c.prototype.remove=function(){b(this.elem).remove()};c.prototype.idUpdate=function(a){b(this.elem).attr("id",a)};c.prototype.editBuild=function(){var a=this,c='<textarea class="caption">'+b(".text",a.elem).text()+"</textarea>";b(".text",a.elem).after(c);b(".caption",a.elem).css({width:b(".view",
a.elem).width()});void 0!=a.culuh&&b(".caption",a.elem).css({"background-color":a.culuh.sat(0.35,!0).hex()});b(".caption",a.elem).hide();b(".text",a.elem).click(function(b){a.editSwitch();b.preventDefault()})};c.prototype.editSwitch=function(){b(".caption",this.elem).is(":visible")?this.editHide():(c.prototype.editHide(),this.editShow())};c.prototype.editHide=function(){b(".caption",this.elem).hide();b(".text",this.elem).show()};c.prototype.editShow=function(){b(".text",this.elem).hide();b(".caption",
this.elem).show();b(".caption",this.elem).cursorToEnd()};c.prototype.viewCrop=function(){b(".view",this.elem).css({width:(this.param.x2-this.param.x1)*this.param.z,height:(this.param.y2-this.param.y1)*this.param.z})};c.prototype.imgMove=function(){b("img.star",this.elem).css({width:b("img.star",this.elem).width()*this.param.z,height:b("img.star",this.elem).height()*this.param.z,left:-1*this.param.x1*this.param.z,top:-1*this.param.y1*this.param.z})};c.prototype.getToJson=function(a){if(""==a)return{};
var b={};a=a.split("%");for(var c=0,f=a.length;c<f;c++){var g=a[c].split("=");2==g.length&&(b[g[0]]=decodeURIComponent(g[1].replace(/\+/g,"")))}return b};c.prototype.html=function(){var a=-1==this.src.indexOf("?")?"?":"&";return('<a class="imgbit" \t\t\t\t\t\thref="'+this.src+"\t\t\t\t\t\t"+a+"imgbit=\t\t\t\t\t\tx1="+this.param.x1+"\t\t\t\t\t\t%y1="+this.param.y1+"\t\t\t\t\t\t%x2="+this.param.x2+"\t\t\t\t\t\t%y2="+this.param.y2+"\t\t\t\t\t\t%c="+this.param.c+"\t\t\t\t\t\t%z="+this.param.z+'">\t\t\t\t\t\t'+
this.caption+"\t\t\t\t\t<a>").smoosh()};c.prototype.citeCoords=function(){var a=[];a[0]=this.param.x1/this.imgWidth;a[1]=this.param.y1/this.imgHeight;a[2]=(this.param.x2-this.param.x1)/this.imgWidth;a[3]=(this.param.y2-this.param.y1)/this.imgHeight;for(var b=0,c=a.length;b<c;b++)a[b]=a[b].toFixed(5);return a};c.prototype.toJsonLD=function(a){return{"@context":"http://www.w3.org/ns/oa-context-20130208.json","@type":"oa:Annotation",annotatedAt:this.timeCreated,annotatedBy:{"@type":"foaf:Person"},motivatedBy:"perseus:transcribing",
label:"isQuotationOf"}};jQuery(document).ready(function(a){jQuery.fn.imgbit=function(a){var b=jQuery(this).selector;return this.each(function(){jQuery.data(this,b,new c(this,a,b))})}})})(jQuery);jQuery.fn.cursorToEnd=function(){return this.each(function(){$(this).focus();if(this.setSelectionRange){var b=2*$(this).val().length;this.setSelectionRange(b,b)}else $(this).val($(this).val());this.scrollTop=999999})};jQuery.fn.myHtml=function(){return $(this).clone().wrap("<div>").parent().html()};
String.prototype.smoosh=function(){return this.replace(/(\r\n+|\n+|\r+|\t+)/gm,"")};function TimeStamp(){}TimeStamp.prototype.withUtc=function(){var b=new Date,c=b.getFullYear(),a=("0"+(b.getMonth()+1)).slice(-2),e=("0"+b.getDate()).slice(-2),d=b.getHours(),f=("0"+b.getMinutes()).slice(-2),g=("0"+b.getSeconds()).slice(-2),b=b.getTimezoneOffset(),c=c+"-"+a+"-"+e+"T"+d+":"+f+":"+g+"UTC";return 0<b?c+"+"+b:c+"-"+b};
function Culuh(b){this.v=this.s=this.h=this.b=this.g=this.r=0;void 0!=b&&(this.original=b,this.reset(),this.hsvUpdate())}Culuh.prototype.reset=function(){var b=this.original,b=b.toUpperCase();-1<b.indexOf("RGB")?(b=b.match(/\d+\.?\d*/g),this.r=parseInt(b[0]),this.g=parseInt(b[1]),this.b=parseInt(b[2])):(b=b.match(/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i),this.r=this.hexToInt(b[1]),this.g=this.hexToInt(b[2]),this.b=this.hexToInt(b[3]))};
